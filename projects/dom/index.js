...
function deleteTextNodes(where) {
  // for (const node of where.childNodes) { Имеет странное поведение, по идее должен удалить все узлы и текстовые, и элементы, но удаляет только тот тип, который встречается первым
